...
const Footer = () => (
  <footer className='container containerFooter'>
    <ul className='nav row d-flex align-items-center justify-content-center'>
    <PrintThisComponent/>
      <li className="text-center mail nav-item col-md-4 col-6">Ayuda:  <a className='MailContacto'href="mailto:contacto@redbus.pe">contacto@redbus.pe</a>   </li>
